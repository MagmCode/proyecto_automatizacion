...
@Component({
  selector: 'app-detalle-cartaaval',
  templateUrl: './detalle-cartaaval.component.html',
  styleUrls: ['./detalle-cartaaval.component.scss']
})
export class DetalleCartaavalComponent implements OnInit {
