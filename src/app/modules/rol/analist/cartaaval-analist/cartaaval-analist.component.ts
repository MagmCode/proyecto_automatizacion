...
@Component({
  selector: 'app-cartaaval-analist',
  templateUrl: './cartaaval-analist.component.html',
  styleUrls: ['./cartaaval-analist.component.scss']
})
export class CartaavalAnalistComponent implements OnInit, AfterViewInit {
  ...
  verDetalle(id: number): void {
    this.router.navigate(['analist/reembolso/detalle', id]);
  }
}
